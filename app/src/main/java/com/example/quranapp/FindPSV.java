...
public class FindPSV {
        ...
        public int getSurahVerse(int surahNo) {
            return surahAyatCount[surahNo];
        }
        ...
        public int getSurahStart(int surahNo) {
            return SSP[surahNo];
        }

        public int getParahStart(int parahNo) {
            return PSV[parahNo];
        }
}
